...
namespace Pulumi.Yandex
{
    ...
    ///         Mounts = new[]
    ///         {
    ///             new Yandex.Inputs.FunctionMountArgs
    ///             {
    ///                 Name = "mnt",
    ///                 EphemeralDisk = new Yandex.Inputs.FunctionMountEphemeralDiskArgs
    ///                 {
    ///                     SizeGb = 32,
    ///                 },
    ///             },
    ///         },
    ///         AsyncInvocation = new Yandex.Inputs.FunctionAsyncInvocationArgs
    ///         {
    ///             RetriesCount = 3,
    ///             ServiceAccountId = "ajeih**********838kk",
    ///             YmqFailureTarget = new Yandex.Inputs.FunctionAsyncInvocationYmqFailureTargetArgs
    ///             {
    ///                 ServiceAccountId = "ajeqr**********qb76m",
    ///                 Arn = "yrn:yc:ymq:ru-central1:b1glr**********9hsfp:fail",
    ///             },
    ///             YmqSuccessTarget = new Yandex.Inputs.FunctionAsyncInvocationYmqSuccessTargetArgs
    ///             {
    ///                 ServiceAccountId = "ajeqr**********qb76m",
    ///                 Arn = "yrn:yc:ymq:ru-central1:b1glr**********9hsfp:success",
    ///             },
    ///         },
    ///         LogOptions = new Yandex.Inputs.FunctionLogOptionsArgs
    ///         {
