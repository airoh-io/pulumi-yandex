...
{
    /// <summary>
    /// Allows management of a Yandex Cloud IAM [service account](https://yandex.cloud/docs/iam/concepts/users/service-accounts). To assign roles and permissions, use the yandex_iam_service_account_iam_binding, yandex_iam_service_account_iam_member and yandex.IamServiceAccountIamPolicy resources.
    /// 
    /// ## Example Usage
    /// 
    /// ```csharp
    ...
    ///     //
    ///     var builder = new Yandex.IamServiceAccount("builder", new()
    ///     {
