...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class DatatransferEndpointSettingsKafkaSourceConnectionOnPremiseTlsModeEnabled
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DatatransferEndpointSettingsKafkaSourceConnectionOnPremiseTlsModeEnabled(string? caCertificate)
        {
