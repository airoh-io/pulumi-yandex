...
namespace Pulumi.Yandex
{
    ...
    ///     //
    ///     var testTable = new Yandex.YdbTable("testTable", new()
    ///     {
    ///         Path = "test_dir/test_table_3_col",
    ///         ConnectionString = yandex_ydb_database_serverless.Database1.Ydb_full_endpoint,
    ///         Columns = new[]
    ///         {
    ///             new Yandex.Inputs.YdbTableColumnArgs
    ///             {
    ///                 Name = "a",
    ///                 Type = "Utf8",
    ///                 NotNull = true,
    ...
    ///         },
    ///         Store = "column",
    ///         PartitioningSettings = new Yandex.Inputs.YdbTablePartitioningSettingsArgs
    ///         {
    ///             PartitionBies = new[]
    ///             {
    ///                 "b",
