 ...
 * //
 * const myQueue = new yandex.MessageQueue("myQueue", {
 ...
 *     }),
 * });
 * const myDeadletterQueue = new yandex.MessageQueue("myDeadletterQueue", {});
 * ```
 *
 * ```typescript
 * import * as pulumi from "@pulumi/pulumi";
 ...
 * //
 * const exampleFifoQueue = new yandex.MessageQueue("exampleFifoQueue", {
