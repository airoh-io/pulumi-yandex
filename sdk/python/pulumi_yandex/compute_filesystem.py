...
class ComputeFilesystemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] block_size: Block size of the filesystem, specified in bytes.
        ...
        :param pulumi.Input[_builtins.int] size: Size of the filesystem, specified in GB.
        :param pulumi.Input[_builtins.str] type: Type of filesystem to create. Type `network-hdd` is set by default.
...
class _ComputeFilesystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The resource name.
        :param pulumi.Input[_builtins.int] size: Size of the filesystem, specified in GB.
        :param pulumi.Input[_builtins.str] status: The status of the filesystem.
        :param pulumi.Input[_builtins.str] type: Type of filesystem to create. Type `network-hdd` is set by default.
        :param pulumi.Input[_builtins.str] zone: The [availability zone](https://yandex.cloud/docs/overview/concepts/geo-scope) where resource is located. If it is not provided, the default provider zone will be used.
        """
        if block_size is not None:
...
class ComputeFilesystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'ComputeFilesystem':
        """
