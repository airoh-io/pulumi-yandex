...
def get_compute_instance_group(instance_group_id: Optional[_builtins.str] = None,
    ...
    my_group = yandex.get_compute_instance_group(instance_group_id="some_instance_group_id")
    pulumi.export("instanceExternalIp", [__item.network_interface[0]["natIpAddress"] for __item in my_group.instances])
    ```
