...
def get_smartcaptcha_captcha(captcha_id: Optional[_builtins.str] = None,
    ...
    by_id = yandex.get_smartcaptcha_captcha(captcha_id=yandex_smartcaptcha_captcha["my-captcha"]["id"])
    ```
    ...
    by_name = yandex.get_smartcaptcha_captcha(name=yandex_smartcaptcha_captcha["my-captcha"]["name"])
    ```
