...
def get_sws_advanced_rate_limiter_profile(advanced_rate_limiter_profile_id: Optional[_builtins.str] = None,
    ...
    by_id = yandex.get_sws_advanced_rate_limiter_profile(advanced_rate_limiter_profile_id=yandex_sws_advanced_rate_limiter_profile["my-profile"]["id"])
    by_name = yandex.get_sws_advanced_rate_limiter_profile(name=yandex_sws_advanced_rate_limiter_profile["my-profile"]["name"])
    ```
