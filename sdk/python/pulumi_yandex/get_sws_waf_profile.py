...
def get_sws_waf_profile(cloud_id: Optional[_builtins.str] = None,
    ...
    by_id = yandex.get_sws_waf_profile(waf_profile_id=yandex_sws_waf_profile["my-profile"]["id"])
    by_name = yandex.get_sws_waf_profile(name=yandex_sws_waf_profile["my-profile"]["name"])
    ```
