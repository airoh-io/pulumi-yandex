...
class IamServiceAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Allows management of a Yandex Cloud IAM [service account](https://yandex.cloud/docs/iam/concepts/users/service-accounts). To assign roles and permissions, use the yandex_iam_service_account_iam_binding, yandex_iam_service_account_iam_member and IamServiceAccountIamPolicy resources.
        ...
        #
        builder = yandex.IamServiceAccount("builder", description="service account to manage VMs")
        ```
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[_builtins.str]] = None,
            folder_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None) -> 'IamServiceAccount':
        """
