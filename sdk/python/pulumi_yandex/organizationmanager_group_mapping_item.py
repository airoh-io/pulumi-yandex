...
class OrganizationmanagerGroupMappingItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        #
        group_mapping_item = yandex.OrganizationmanagerGroupMappingItem("groupMappingItem",
            federation_id="my-federation_id",
            internal_group_id="my_internal_group_id",
            external_group_id="my_external_group_id",
            opts = pulumi.ResourceOptions(depends_on=[yandex_organizationmanager_group_mapping["group_mapping"]]))
        ```
